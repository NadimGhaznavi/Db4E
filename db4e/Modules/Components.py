...
from db4e.Constants.Fields import (
    ANY_IP_FIELD, CHAIN_FIELD, DATA_DIR_FIELD, STDIN_FIELD,
    DONATION_WALLET_FIELD, GROUP_FIELD, IN_PEERS_FIELD,
    INSTALL_DIR_FIELD, INSTANCE_FIELD, IP_ADDR_FIELD, 
    ...
    STRATUM_PORT_FIELD, USER_FIELD, USER_WALLET_FIELD, 
...
from db4e.Constants.Labels import (
    ...
    NUM_THREADS_LABEL, OUT_PEERS_LABEL, P2P_BIND_PORT_LABEL, STDIN_LABEL,
...
class Stdin(Component):
    def __init__(self):
        super().__init__(STDIN_FIELD, STDIN_LABEL)

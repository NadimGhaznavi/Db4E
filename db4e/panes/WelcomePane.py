...
class WelcomePane(Container):
    ...
    def compose(self) -> ComposeResult:
        ...
        highlights.add_row(
            "🔒",
            "[#31b8e6]Security[/]",
            "[#31b8e6]Built-in security architecture with sudoers-based privilege management.[/]",
        )
        highlights.add_row(
            "🧩",
            "[#31b8e6]Modular Design[/]",
            "[#31b8e6]Future-proof upgrades of Monerod, P2Pool, and XMRig.[/]",
        )
        highlights.add_row(
            "✅",
            "[#31b8e6]Git Workflow[/]",
            "[#31b8e6]Active development in Git branches, keeping `main` clean and stable.[/]",
        )
        highlights.add_row(
            "📈",
            "[#31b8e6]Historical Data[/]",
            "[#31b8e6]Rich historical data tracking for mining performance and yield.[/]",
        )
        highlights.add_row(
            "🧙",
        ...
        highlights.add_row(
            "📚",
            "[#31b8e6]Log Managment[/]",
            "[#31b8e6]Automatic log file compress and rotation[/]",
        )
        highlights.add_row(
            "📥",
            "[#31b8e6]Mongo Backups[/]",
            "[#31b8e6]Automatic backups of Mongo database[/]",
        )
        highlights.add_row(
            "🟢",
            "[#31b8e6]Health Checks[/]",
            "[#31b8e6]Built in health check indicators: 🟢, 🟡, 🔴[/]",
        )

        coming = Table(
            title="[cyan b]Coming Soon[/]",
            show_header=True,
            box=box.SIMPLE,
            border_style="#0c323e",
            padding=(0, 1),
        ...
        coming.add_row(
            "📢",
            "[#31b8e6]Version Checker[/]",
            "[#31b8e6]PyPI release checking — automatic version notifications.[/]",
        )
        coming.add_row(
            "🔒",
            "[#31b8e6]Security Docs[/]",
            "[#31b8e6]Full security architecture documentation.[/]",
        )
        coming.add_row(
            "🐞",
            "[#31b8e6]Testing + CI/CD[/]",

...
class P2PoolSharesFoundPane(Container):
    ...
    def compose(self):
        ...
        yield Vertical(
            ScrollableContainer(
                ...
                Vertical(self.select_widget, classes=DForm.SELECT_BOX),
    ...
    def set_data(self, p2pool: P2Pool):
        ...
        INTRO = (
            f"View historical [i]Shares Found[/] data for the "
        ...
        if type(data) == dict:
            ...
            self.cur_days, self.cur_shares_found = self.reduce_data(
                self.days, self.shares_found
            )

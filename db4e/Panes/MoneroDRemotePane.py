...
from db4e.Constants.Fields import (
    ...
    DELETE_BUTTON_FIELD, DELETE_DEPLOYMENT_FIELD, 
    FORM_4_FIELD, FORM_INPUT_30_FIELD, FORM_INTRO_FIELD, FORM_LABEL_FIELD,
    MONEROD_REMOTE_FIELD, HEALTH_BOX_FIELD, OPS_MGR_FIELD, 
    PANE_BOX_FIELD, RED_BUTTON_FIELD, ELEMENT_FIELD, NEW_BUTTON_FIELD, 
    TO_METHOD_FIELD, TO_MODULE_FIELD, UPDATE_FIELD, UPDATE_BUTTON_FIELD,
    UPDATE_DEPLOYMENT_FIELD, NEW_FIELD)
from db4e.Constants.Labels import (
    DELETE_LABEL, INSTANCE_LABEL, IP_ADDR_LABEL, MONEROD_REMOTE_LABEL,
    RPC_BIND_PORT_LABEL, UPDATE_LABEL, ZMQ_PUB_PORT_LABEL, NEW_LABEL)

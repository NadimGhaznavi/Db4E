...
class PoolHashrate(BaseHourlyMining):
    """
    Record representing pool hashrate by chain per hour.
    """

    def __init__(self, pool=None, chain=None, hashrate=None, units=None, rec=None):
        """
        Initialize the pool hashrate record and optionally hydrate from a DB record.
    ...
    def to_dict(self):
        ...
        :return: Dictionary with pool hashrate fields.
        :rtype: dict
        """
        data = super().to_dict()
        data.update(

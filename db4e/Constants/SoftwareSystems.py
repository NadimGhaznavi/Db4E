...
from db4e.Constants.Fields import (
    COMPONENTS_FIELD, DB4E_FIELD, ELEMENT_TYPE_FIELD, FIELD_FIELD, HEALTH_MSGS_FIELD,
    MONEROD_FIELD, MONEROD_REMOTE_FIELD, NAME_FIELD, P2POOL_FIELD, P2POOL_REMOTE_FIELD,
    SOFTWARE_SYSTEM_FIELD, VERSION_FIELD, XMRIG_FIELD, MACHINE_FIELD)
from db4e.Constants.Labels import (
    DB4E_LABEL, MACHINE_LABEL, MONEROD_LABEL, P2POOL_LABEL, XMRIG_LABEL)
from db4e.Constants.Components import (
    ANY_IP, CHAIN, CONFIG, DATA_DIR, DONATION_WALLET, GROUP, IN_PEERS, 
    INSTALL_DIR, INSTANCE, IP_ADDR, LOCAL, LOG_LEVEL, LOG_NAME, MAX_LOG_FILES, 
...
Db4E_Template = {
    ...
    ELEMENT_TYPE_FIELD: SOFTWARE_SYSTEM_FIELD,
    FIELD_FIELD: DB4E_FIELD,
...
# Machine Instance
Machine_Template = {
    NAME_FIELD: MACHINE_LABEL,
    ELEMENT_TYPE_FIELD: SOFTWARE_SYSTEM_FIELD,
    FIELD_FIELD: MACHINE_FIELD,
    HEALTH_MSGS_FIELD: [],
    COMPONENTS_FIELD: [
        IP_ADDR
    ],
...
MoneroD_Remote_Template = {
    NAME_FIELD: MONEROD_LABEL,
    ELEMENT_TYPE_FIELD: SOFTWARE_SYSTEM_FIELD,
    FIELD_FIELD: MONEROD_REMOTE_FIELD,
    HEALTH_MSGS_FIELD: [],
    COMPONENTS_FIELD: [
        INSTANCE, REMOTE, RPC_BIND_PORT, ZMQ_PUB_PORT],
} 
...
P2Pool_Remote_Template = {
    ...
    HEALTH_MSGS_FIELD: [],
    COMPONENTS_FIELD: [
        INSTANCE, REMOTE, STRATUM_PORT]
    }

XMRig_Template = {
    NAME_FIELD: XMRIG_LABEL,
    ELEMENT_TYPE_FIELD: SOFTWARE_SYSTEM_FIELD,
    FIELD_FIELD: XMRIG_FIELD,

...
The *db4e* application supports defining custom reports using a simple YAML file. Custom reports are generated by running `db4e.py -r REPORT_TYPE`. The *db4e* application reads a user-defined reports definitions file, retrieves the necessary data and publishes the results to the web. The following report types have been implemented:

* [Report Types](/pages/web/index.html)
  * [Hashrate Reports](/pages/reports/hashrate/index.html) - Scheduled
  * [Payment Reports](/pages/reports/payment/index.html) - Event driven
  * [Blocks Found on the Sidechain](/pages/reports/blocksfound/index.html) - Event driven

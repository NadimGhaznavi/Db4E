...
The *db4e* application supports defining custom reports using a simple YAML file. Custom reports are generated by running `db4e.py -a run_reports`. The *db4e* application reads a user-defined [reports definitions file](/conf/reports.yml), retrieves the necessary data and publishes the results to the web. 

The currently configured reports include the following:

Local P2Pool hashrate | [30 day](/pages/reports/Pool-Hashrate-30-Days.html), [60 day](/pages/reports/Pool-Hashrate-60-Days.html), [90 day](/pages/reports/Pool-Hashrate-90-Days.html) and [all](/pages/reports/Pool-Hashrate.html)
Sidechain hashrate    | [30 day](/pages/reports/Sidechain-Hashrate-30-Days.html), [60 day](/pages/reports/Sidechain-Hashrate-60-Days.html), [90 day](/pages/reports/Sidechain-Hashrate-90-Days.html) and [all](/pages/reports/Sidechain-Hashrate.html)
Mainchain hashrate    | [30 day](/pages/reports/Mainchain-Hashrate-30-Days.html), [60 day](/pages/reports/Mainchain-Hashrate-60-Days.html), [90 day](/pages/reports/Mainchain-Hashrate-90-Days.html) and [all](/pages/reports/Mainchain-Hashrate.html)

A [summary page](/pages/reports/index.html) of all reports is also generated.

Report generation is scheduled on the half hour with a cronjob.

...
The *db4e* application supports defining custom reports using a simple YAML file. Custom reports are generated by running `db4e.py -r REPORT_TYPE`. The *db4e* application reads a user-defined reports definitions file, retrieves the necessary data and publishes the results to the web. 

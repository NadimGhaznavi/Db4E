"""
lib/Mining/Db4eOSInitialSetupUI/Db4eOSInitialSetupUI.py
...
class Db4eOSInitialSetupUI:
    def __init__(self, parent_tui):
        ...
        form_widgets = [
            urwid.Text('IMPORTANT NOTE: The software deployment and GitHub pages website directories '
                       'can *NOT* be within the base db4e directory.\n\n' +
                       'When you click on "Proceed" you will be prompted for your ' +

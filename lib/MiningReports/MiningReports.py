"""
lib/MiningReports/MiningReports.py

The MiningReports module accepts a *db4e* reports definition file 
and performs the following operations:

* Creates CSV files with data from MongoDB
* Generates report specific Javascript files
* Generates report specific GitHub Flavored Markdown (GFM) files
* Generates a report GFM report summary page
* Pushes the files to the *db4e* GitHub Pages website.

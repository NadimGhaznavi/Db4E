...
class Db4eStartup():
  ...
  def __init__(self):
    ...
    self._short_pool_hashrates_csv = config[environ]['short_pool_hashrates_csv']
    self._sidechain_hashrates_csv = config[environ]['sidechain_hashrates_csv']
    self._short_sidechain_hashrates_csv = config[environ]['short_sidechain_hashrates_csv']
    self._mainchain_hashrates_csv = config[environ]['mainchain_hashrates_csv']
    self._short_mainchain_hashrates_csv = config[environ]['short_mainchain_hashrates_csv']
  ...
  def short_pool_hashrates_csv(self):
    return self._short_pool_hashrates_csv
  
  def sidechain_hashrates_csv(self):
    return self._sidechain_hashrates_csv
  
  def short_sidechain_hashrates_csv(self):
    return self._short_sidechain_hashrates_csv
  
  def mainchain_hashrates_csv(self):
    return self._mainchain_hashrates_csv
  
  def short_mainchain_hashrates_csv(self):
    return self._short_mainchain_hashrates_csv
